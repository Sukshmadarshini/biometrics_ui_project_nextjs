      ...
      <Body style={{ backgroundColor: "#f4f6f8", padding: "20px", margin: 0 }}>
        ...
        >
          ...
          <Section style={{ padding: "28px 25px" }}>
            ...
            >
              <Row style={{ borderBottom: "1px solid #e2e8f0", backgroundColor: "#f9fafb" }}>
                <Column style={{ padding: "12px", width: "120px" }}>
                  <Text style={{ margin: 0, fontWeight: "bold" }}>Title</Text>
                </Column>
                <Column style={{ padding: "12px" }}>
                  <Text style={{ margin: 0 }}>{title}</Text>
                </Column>
              ...
              <Row style={{ borderBottom: "1px solid #e2e8f0" }}>
                <Column style={{ padding: "12px", width: "120px" }}>
                  <Text style={{ margin: 0, fontWeight: "bold" }}>Author</Text>
                </Column>
                <Column style={{ padding: "12px" }}>
                  <Text style={{ margin: 0 }}>{author}</Text>
                </Column>
              ...
              {email && (
                <Row style={{ borderBottom: "1px solid #e2e8f0" }}>
                  <Column style={{ padding: "12px", width: "120px" }}>
                    <Text style={{ margin: 0, fontWeight: "bold" }}>Email</Text>
                  </Column>
                  <Column style={{ padding: "12px" }}>
                    <Text style={{ margin: 0 }}>{email}</Text>
                  </Column>
              ...
              <Row>
                <Column style={{ padding: "12px", width: "120px" }}>
                  <Text style={{ margin: 0, fontWeight: "bold" }}>Read Time</Text>
                </Column>
                <Column style={{ padding: "12px" }}>
                  <Text style={{ margin: 0 }}>{readTime}</Text>
                </Column>
            ...
            >
              <Text style={{ margin: 0, fontSize: "14px", lineHeight: "1.7", color: "#374151" }}>
                {excerpt}
              </Text>
            </Section>

            <Text style={{ fontSize: "13px", color: "#6b7280", marginBottom: "18px" }}>
              {emailContent.reviewNote}
            </Text>
