...
// interface ReturnConsultationEmailProps {
//   name: string;
//   email: string;
//   serviceTitle: string;
//   serviceId: string;
...
// export default function ReturnConsultationEmail({
//   name,
//   email,
//   serviceTitle,
//   price,
...
//               A new consultation registration has been received. Payment is pending verification.
//               Please review the details below and confirm once payment is received.
//             </Text>
    ...
    <Html>
      ...
      <Body style={{ backgroundColor: "#f4f6f8", padding: "20px", margin: 0 }}>
        ...
        >
          ...
          <Section style={{ backgroundColor: "#f9fafb", padding: "15px", textAlign: "center" }}>
            <Text style={{ fontSize: "12px", color: "#6b7280", margin: 0 }}>
              {emailContent.footerText} · Ref: {transactionRef}
            </Text>
          </Section>
        </Container>
      </Body>
