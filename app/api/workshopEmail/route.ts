...
export async function POST(req: NextRequest) {
  try {
    ...
    const emailContents = await getEmailContents(["workshop", "returnWorkshop"]);

    const ownerEmailContent = {
      headerTitle:    "New Workshop Enquiry",
      headerSubtitle: "Institute / College / University",
      bodyText:       "A new workshop enquiry has been submitted by an institute representative.",
      footerText:     "This enquiry was submitted via the Sukshmadarshini workshop booking form.",
      ...emailContents["workshop"],
    };

    const clientEmailContent = {
      headerTitle:    "Enquiry Received",
      headerSubtitle: "Sukshmadarshini™ Workshop Division",
      bodyText:       "Thank you for your interest in hosting a Sukshmadarshini™ workshop. We have received your enquiry and our team will review it and reach out to you shortly to discuss the details and next steps.",
      nextStepsTitle: "What happens next?",
      step1:          "📬 Your enquiry has been forwarded to our workshop coordination team.",
      step2:          "🕐 A team member will contact you within 2 to 3 business days to discuss scheduling, logistics, and pricing.",
      signOff:        "If you have any immediate questions, feel free to reply to this email and we'll get back to you promptly.",
      footerText:     "This email was sent from Sukshmadarshini™ Workshop Division.",
      ...emailContents["returnWorkshop"],
    };
    ...
    const [ownerResult, clientResult] = await Promise.allSettled([
      ...
      resend.emails.send({
        ...
        react:   WorkshopEmail({
          ...
          workshopTitle, workshopId, estimatedParticipants, message,
          emailContent: ownerEmailContent,
        }),
      }),

      // 2️⃣  To the institute contact — acknowledgement
      resend.emails.send({
        from:    process.env.CLIENT_EMAIL_FROM!,
        to:      email,
        replyTo: process.env.EMAIL_TO!,
        ...
        react:   ReturnWorkshopEmail({
          contactName, email, instituteName, city, designation, phone,
          workshopTitle, estimatedParticipants, message,
